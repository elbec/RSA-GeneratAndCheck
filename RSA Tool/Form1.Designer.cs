namespace RSA_Tool
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            var myControls = this.Controls;
            myControls.Add(this.pictureBox_check);
            myControls.Add(this.pictureBox_Sign1);
            myControls.Add(this.pictureBox_Sign);
            myControls.Add(this.pictureBox_createKeys);
            myControls.Add(this.checksign);
            myControls.Add(this.label4);
            myControls.Add(this.textBoxSourceText);
            myControls.Add(this.signtext);
            myControls.Add(this.label3);
            myControls.Add(this.textBoxSignature);
            myControls.Add(this.createKeys);
            myControls.Add(this.label2);
            myControls.Add(this.label1);
            myControls.Add(this.textBoxPublicKey);
            myControls.Add(this.textBoxPrivateKey);
            this.Name = "Form1";
